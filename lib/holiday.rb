...
def add_supply_to_winter_holidays(holiday_hash, supply)
  ...
  holiday_hash[:winter][:new_years] << supply  # holiday_hash is identical to the one above
...
def all_holidays_with_bbq(holiday_hash)
  ...
  bbq_holiday# return an array of holiday names (as symbols) where supply lists
